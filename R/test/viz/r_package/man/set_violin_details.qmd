---
title: "Set up violin plot details"
---
...
| bandwidth | Box plot color |
| samples | Box plot opacity. Max: 1. |
| color | Line color. |
| opacity | Line width. |
| sizing | Whisker type. Allowed values:"tukey", "all". |
...
## See Also
 Other Flourish line, bar, pie chart and scatterplots:  `bind_data()`, `bind_racing_bar_chart_data()`, `bind_racing_line_chart_data()`, `set_area_details()`, `set_bar_column_details()`, `set_boxplot_details()`, `set_line_details()`, `set_racing_bar_chart_details()`, `set_racing_line_chart_details()`, `set_scatterplot_details()`, `set_segment_details()` 
